...
class ScriptedInstaller extends ScriptedInstallBase
{
    ...
    {
        $sql =
            'ALTER TABLE ' . TABLE_MANUFACTURERS . '
        ...
        $sql = "INSERT IGNORE INTO " . TABLE_PRODUCT_TYPE_LAYOUT . " (configuration_title, configuration_key, configuration_value, configuration_description, product_type_id, sort_order, date_added, set_function, last_modified)
               VALUES
